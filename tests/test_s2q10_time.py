...
#print("Le temps nécessaire est :",  estimation_duree(2), "s") 
#print("Le temps nécessaire est :",  estimation_duree(3), "s")
#print("Le temps nécessaire est :",  estimation_duree(4), "s")
